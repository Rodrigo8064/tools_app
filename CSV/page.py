...
from CSV.functions import dividir_csv, corrigir_csv, formatar_csv
...
class CsvToolsWindow(QWidget):
    def __init__(self, main_window):
        ...
        # Botão Corrigir CSV
        corrigir_button = QPushButton("Corrigir CSV")
        corrigir_button.setFixedHeight(40)
        corrigir_button.clicked.connect(self.corrigir_csv_action)
    ...
    def corrigir_csv_action(self):
        """Ação para o botão Corrigir CSV"""
        corrigir_csv(self)
